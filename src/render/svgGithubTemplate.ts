...
export function renderSVG(
    ...
    // IMPORTANT: Use hourly_counts (24-hour distribution), NOT interval_counts
    // hourly_counts aggregates all commits by hour of day (0-23) regardless of which day
    ...
    const mostActiveCount = mostActiveHour !== null ? tzHourlyCounts[mostActiveHour] : 0
    ...
    // Create a more descriptive subtitle for the peak hour
    const peakHourSubtitle = mostActiveHour !== null
        ? `${mostActiveCount} commit${mostActiveCount !== 1 ? 's' : ''} this hour`
    ...
    <g class="root">
        ...
        <g transform="translate(${pad + (metricCardW + metricGap) * 2}, ${metricY})">
            ...
            <g transform="translate(${metricCardW/2}, ${metricCardH/2})">
                ...
                <text x="0" y="100" text-anchor="middle" class="metric-sub">${peakHourSubtitle}</text>
            </g>
        </g>
