...
<svg xmlns="http://www.w3.org/2000/svg"
    ...
    <g class="root">
        <g transform="translate(${pad}, 70)">
            ...
            <circle cx="${contentW - 10}" cy="25" r="7" fill="#ef4444" opacity="0.8"/>
            <circle cx="${contentW - 40}" cy="25" r="7" fill="#eab308" opacity="0.8"/>
            <circle cx="${contentW - 70}" cy="25" r="7" fill="#22c55e" opacity="0.8"/>
        </g>
        ...
        <g transform="translate(${pad}, ${height - 40})">
            <text x="0" y="0" fill="${sub}" font-size="14" font-weight="600">
                Generated by Weft
            </text>
            <text x="${contentW}" y="0" text-anchor="end" fill="${sub}" font-size="14" font-weight="600">
                Snapshot: ${timestamp}
            </text>
        </g>
    </g>
